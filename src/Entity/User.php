...
class User implements UserInterface, JsonSerializable, PasswordAuthenticatedUserInterface
{
    ...
    {
        $roles = $this->roles;
        // Tenga en cuenta que tampoco necesito agregar ROLE_USER: el getRoles()método
        // se asegurará de que se devuelva incluso si no está almacenado en la base de datos:
